...
public:
	...
	void NetSettings(NET &net) {
		for (int i = 0; i < net.NodeScale(2); i++) {
			...
			net.Configuration[i].Velocity(2) = 1.0;
		}
		
		net.Configuration[net.NodeScale(2) - 1].Velocity(2) = 4.0;
		net.Configuration[net.NodeScale(2) - 2].Velocity(2) = 4.0;
		net.Configuration[net.NodeScale(2) - 3].Velocity(2) = 4.0;
		net.Configuration[net.NodeScale(2) - 4].Velocity(2) = 2.0;
